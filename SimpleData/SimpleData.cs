...
namespace SimpleData
{
    ...
    public class Do
    {
        public static async Task<ObservableCollection<SampleItem>> CreateItems(int count)
        {
            ...
            await Task.Run(() =>
            {
                ...
                {
                    var date = new DateTime(2018, random.Next(8, 10), random.Next(1, 28));
                    var month = new DateTime(date.Year, date.Month, 1);
                    int quantity = random.Next(1, 1000);
                    decimal price = random.Next(1, 5) * (decimal)random.NextDouble();
                    int customer = random.Next(1, 100);
                    int category = random.Next(1, 10);
                    string country = null;
                    ...
                    items.Add(new SampleItem
                    {
                        ...
                        Customer = $"Customer {customer:000}",
                        Country = country,
                        Quantity = quantity,
                        Price = price,
                        Checked = random.NextDouble() > 0.5,
